 ...
 */
package com.mine.crypto.ethereum;


import com.mine.crypto.ECKeyPair;
import com.mine.crypto.Transaction;
import com.mine.crypto.bip32.ValidationException;
import com.mine.crypto.ethereum.rlp.RLP;
import com.mine.crypto.ethereum.rlp.RLPElement;
import com.mine.crypto.ethereum.rlp.RLPItem;
import com.mine.crypto.ethereum.rlp.RLPList;
import com.mine.crypto.ethereum.utils.ByteUtil;
import com.mine.crypto.utils.KECCAK256;
...
//                Log.e("=====", "RLP encoded tx is not signed!");
                System.out.println("RLP encoded tx is not signed!");
            }
            this.parsed = true;
            this.hash = getHash();
        } catch (Exception e) {
